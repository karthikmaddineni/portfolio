    ...
    <section id="about" class="animate-in">
        ...
        <div class="about-content">
            ...
            <div class="about-text">
                <p>Hello! I'm Karthik Maddineni, newly graduated and a passionate full-stack developer with over 1 year of combined intership experience of creating beautiful, functional, and user-centered digital experiences.</p>
